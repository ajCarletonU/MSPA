%----------------------------
%PA9 - 5. Material changes: - new basic_fullvestor.m
%make it run for single mode and only TE.
% changes the Ridge index from 3.305 to 3.44 in 10 steps.
%----------------------------
...
n3 = linspace(3.305,3.44,10);   % Upper cladding (air) - change on Hy

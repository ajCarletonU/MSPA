...
%----------------------------
%PA9 - 3(d) edit contour to use surf()
%----------------------------   
% Compute and plot contours
surf(x,y,20*log10(abs(transpose(mode))));
shading interp      %Show colour - varies the color in each line segment 
view(2)             %set to 2D view  0,90, as contour is 2D

%surf() plot data is the same as contour - differenc is the 2D vs 3D.
%surf() has less code
